...
export default function ProcessingScreen() {
  ...
  return (
    <>
      ...
      >
        {/* ── Appraisal ── */}
        <Text style={styles.sectionLabel}>Appraisal</Text>
        ...
        <Text style={styles.sectionLabel}>Environmental Review</Text>
        <View style={styles.card}>
        ...
        {/* ── Borrower Forms ── */}
        <Text style={styles.sectionLabel}>Borrower Forms</Text>
        ...
        {/* ── HMDA / Compliance ── */}
        <Text style={styles.sectionLabel}>HMDA & Compliance (Pre-close)</Text>
        <Text style={styles.sectionNote}>
