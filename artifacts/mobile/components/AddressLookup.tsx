...
type Props = {
  /** Current street address value (for display in the input). */
  value: string;
    ...
    <View style={styles.wrapper}>
      <View style={styles.inputRow}>
        ...
        <TextInput
          ...
          placeholder={hasKey ? placeholder : "Enter street address manually"}
      ...
      {!hasKey && (
        <Text style={styles.noKeyHint}>
          Add EXPO_PUBLIC_GOOGLE_MAPS_API_KEY to enable address autocomplete.
        </Text>
      )}
